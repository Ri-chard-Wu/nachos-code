...
class FileSystem {
 ...
 public:
  ...
  bool Create(char *name) {
    ...
    int fileDescriptor = OpenForWrite(name); // create a file if doesn't exist.
  ...
  OpenFile *Open(char *name) { 
    ...
    int fileDescriptor = OpenForReadWrite(name, FALSE); // error if doesn't exist.
  ...
  */
  OpenFileId OpenAFile(char *name) {
      ...
      cerr << "[OpenAFile()] nOpenFile: " << nOpenFile << "\n"; 
  ...
  */
  int WriteFile(char *buffer, int size, OpenFileId id) {
      ...
      int numWritten = OpenFileTable[id]->Write(buffer, size);
      return numWritten;
  }
